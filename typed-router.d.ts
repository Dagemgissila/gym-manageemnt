...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'members-create-membership': RouteRecordInfo<'members-create-membership', '/members/create/membership', Record<never, never>, Record<never, never>>,
    'members-create-prospect': RouteRecordInfo<'members-create-prospect', '/members/create/prospect', Record<never, never>, Record<never, never>>,
