...
class RoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
		...
		$adminRole->display_name = RoleType::ADMIN;
		...
		$salesmaneRole->display_name = RoleType::STAFF;
		...
		$salesmaneRole->display_name = RoleType::TRAINER;
		...
		$salesmaneRole->display_name = RoleType::MEMBER;
